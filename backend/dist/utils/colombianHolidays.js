...
function getColombianHolidays(year) {
    ...
    holidays.push({ date: new Date(year, 0, 1), name: "Año Nuevo", isFixed: true }, { date: new Date(year, 0, 8), name: "Epifanía", isFixed: true }, { date: new Date(year, 2, 29), name: "San José", isFixed: true }, { date: new Date(year, 4, 1), name: "Día del Trabajo", isFixed: true }, { date: new Date(year, 5, 3), name: "Sagrado Corazón", isFixed: true }, { date: new Date(year, 6, 4), name: "San Pedro y San Pablo", isFixed: true }, { date: new Date(year, 7, 7), name: "Independencia Nacional", isFixed: true }, { date: new Date(year, 7, 15), name: "Asunción de María", isFixed: true }, { date: new Date(year, 8, 8), name: "Coronación de María", isFixed: true }, { date: new Date(year, 10, 1), name: "Todos los Santos", isFixed: true }, { date: new Date(year, 10, 11), name: "Independencia de Cartagena", isFixed: true }, { date: new Date(year, 11, 8), name: "Inmaculada Concepción", isFixed: true }, { date: new Date(year, 11, 25), name: "Navidad", isFixed: true });
