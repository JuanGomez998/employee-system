...
exports.getCurrentUserController = exports.registerController = exports.loginController = void 0;
...
const registerController = async (req, res) => {
    try {
        ...
        const user = await authService.register(username, email, password, role || "employee", employee_cedula);
